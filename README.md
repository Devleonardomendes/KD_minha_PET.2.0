...
Baixe o instalador Windows em [`downloads/KD_minha_PET.4.0_Setup.exe`](downloads/KD_minha_PET.4.0_Setup.exe).
...
- Filtro por tipo de documento identificado no texto inicial/primeira pagina: Contestacao, Apelacao, Contrarrazoes/Contra-Razoes, Impugnacao, Agravo de instrumento, Outros ou todos os documentos.
...
| Perfil de uso | Memoria total RAM+VRAM recomendada |
|---|---:|
